		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Goods",
									"targetURL": "#commanagegoods-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commanagegoods-display": {
								"semanticObject": "commanagegoods",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.managegoods",
									"url": sap.ui.require.toUrl("com/managegoods")
								}
							}
						}
					}
